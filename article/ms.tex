...
% APOGEE has most. Probably best to test this with.

% Use GES data for matching to SDSS-like stuff.


\begin{figure}
\includegraphics[width=0.5\textwidth]{figures/hipparcos-hrd.eps}
...
\begin{figure}
\includegraphics[width=0.5\textwidth]{figures/hipparcos-plx.eps}
...
\begin{figure*}
\includegraphics[width=\textwidth]{figures/cluster-hrds.eps}
...
\begin{figure}
\includegraphics[width=\textwidth]{figures/cluster-distances.eps}
